...
public class RegisterAssociationPanel extends JPanel {
    public RegisterAssociationPanel(JPanel mainPanel, CardLayout cardLayout) {
        ...
        JButton registerButton = new JButton("Register Association");
        ...
        registerButton.addActionListener(e -> {
            ...
            if (location.isEmpty()) errors.append("- Location cannot be empty\n");
            ...
            if (errors.length() > 0) {
                ...
                try {
                    ...
                    Association assoc = service.registerAssociationUser(username, password, email, name, location);
                    if (assoc != null) {
                        JOptionPane.showMessageDialog(this, "Association registered successfully!");
